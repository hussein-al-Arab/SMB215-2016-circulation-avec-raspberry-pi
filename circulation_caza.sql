...
CREATE TABLE `caza` (
  `idcaza` int(11) NOT NULL,
  `caza` varchar(45) NOT NULL,
  PRIMARY KEY (`idcaza`),
  UNIQUE KEY `idcaza_UNIQUE` (`idcaza`),
  UNIQUE KEY `caza_UNIQUE` (`caza`)
...
LOCK TABLES `caza` WRITE;
/*!40000 ALTER TABLE `caza` DISABLE KEYS */;
/*!40000 ALTER TABLE `caza` ENABLE KEYS */;
UNLOCK TABLES;
